...
class AndroidCanvas(canvas: android.graphics.Canvas) extends Canvas {
  ...
  def drawImage(id: Int, x: Int, y: Int) {
    canvas.drawBitmap(AndroidBitmapFactory.bitmaps(id), x, y, null)
  }

  def drawImage(id: Int, dx1: Int, dy1: Int, dx2: Int, dy2: Int, sx1: Int, sy1: Int, sx2: Int, sy2: Int) {
    canvas.drawBitmap(AndroidBitmapFactory.bitmaps(id), new Rect(sx1, sy1, sx2, sy2), new Rect(dx1, dy1, dx2, dy2), null)
  }
