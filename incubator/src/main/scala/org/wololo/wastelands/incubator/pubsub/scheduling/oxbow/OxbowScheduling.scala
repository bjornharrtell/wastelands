package org.wololo.wastelands.incubator.pubsub.scheduling.oxbow
...
class LimitedScheduledFuture(self: ScheduledFuture[_]) extends Schedules with Intervals {
   ...
   * }}}
   */
  def untilNext[I, D, T](t: T, zone: TimeZone = TimeZone.getDefault)(implicit ev: TimeLike[T, D, I], ev2: InstantLike[I], ev3: DateLike[D], strategy: Scheduler) = until(next(t, zone))
   ...
   * }}}
   */
  def untilNextZoned[I, D, Z](t: Z)(implicit ev: ZonedTimeLike[Z, D, I], ev2: InstantLike[I], ev3: DateLike[D], strategy: Scheduler) = untilNext(t, ev.zone(t))
 ...
 * or even periodic
 */
class Schedule(f: => Unit) extends Intervals with Schedules {
  ...
  def onceAtNext[T, D, I](t: T, zone: TimeZone = TimeZone.getDefault)(implicit ev: TimeLike[T, D, I], ev2: InstantLike[I], ev3: DateLike[D], strategy: Scheduler): ScheduledFuture[_] = onceAt(next(t, zone))

  def onceAtNextZoned[Z, D, I](t: Z)(implicit ev: ZonedTimeLike[Z, D, I], ev2: InstantLike[I], ev3: DateLike[D], strategy: Scheduler): ScheduledFuture[_] = onceAtNext(t, ev.zone(t))
  ...
  def dailyAtZoned[Z, D, I](t: Z, immediatelyIfAfter: Boolean = true)(implicit ev: ZonedTimeLike[Z, D, I], ev2: InstantLike[I], ev3: DateLike[D], strategy: Scheduler): ScheduledFuture[_] = dailyAt(t, ev.zone(t), immediatelyIfAfter)
   ...
   */
  def dailyAt[T, D, I](t: T, zone: TimeZone = TimeZone.getDefault, immediatelyIfAfter: Boolean = true)(implicit ev: TimeLike[T, D, I], ev2: InstantLike[I], ev3: DateLike[D], strategy: Scheduler): ScheduledFuture[_] = {
